...
logo.setAttribute("src", "./assest/images/Images/logos/new_logo.png");
/*logo.src = request.getContextPath()+ "/assest/images/Images/logos/new_logo.png";	*/
...
span_proffesion.innerHTML = "Fresh BY Entertainment";
...
a_home_page.setAttribute("href", "/assest/pages/Home.html");
...
i_cart_add_icon.setAttribute("class", "bx bx-chat icon");
...
span_cart_add_icon.innerHTML = "Chats";
a_Cart.append(span_cart_add_icon);

let li_nav_link41 = document.createElement("li");
li_nav_link41.setAttribute("class", "nav-link");
ul_menu_links.append(li_nav_link41);

let b_Cart = document.createElement("a");
b_Cart.setAttribute("href", "/assest/pages/Byevideo.jsp");
...
let Span_cart_add_icon = document.createElement("i")
Span_cart_add_icon.setAttribute("class", "text nav-text");
Span_cart_add_icon.innerHTML = "Videos";
b_Cart.append(Span_cart_add_icon);
...
a_Profile.setAttribute("href", "/assest/pages/Invite_page.jsp");
...
li_nav_link5_1.setAttribute("class", "nav-link");
ul_menu_links.append(li_nav_link5_1);

let a_Profil = document.createElement("a");
a_Profil.setAttribute("href", "/UserProfile");
li_nav_link5_1.append(a_Profil);

let i_user_ico = document.createElement("i");
i_user_ico.setAttribute("class", "bx bx-user icon");
a_Profil.append(i_user_ico);

let span_user_ico = document.createElement("i");
span_user_ico.setAttribute("class", "text nav-text");
span_user_ico.innerHTML = "Profile";
a_Profil.append(span_user_ico);
...
i_pie_chart_alt_icon.setAttribute("class", "bx bx-exit icon");
...
span_pie_chart_alt_icon.innerHTML = "Logout";
