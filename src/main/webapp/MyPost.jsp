...
<body>
	...
	List<Post> listOfPost = (List<Post>) request.getAttribute("myPosts");
	...
	<div id="Home" class="Home">
		<div id="title" class="text">My Posts</div>
			...
			<div id="post-section">
				...
				<div id="solo-post">
					...
					<div>
						...
						<a class="Likes"
							href="<%=request.getContextPath()%>/addLike?postId=<%=post.getpostId()%>"
							style="pointer-events: none;"><span><%=likeCount%></span>
							Likes</a> <a class="Likes"
							href="<%=request.getContextPath()%>/addLike?postId=<%=post.getpostId()%>">
							Update</a> <a class="Likes"
							href="<%=request.getContextPath()%>/addLike?postId=<%=post.getpostId()%>">Delete</a>
						<%
						if (isAdmin == true) {
						%>
						<a class="Block"
	...
	<nav class="sidebar close">
		...
		<div class="menu-bar">
			<div class="menu">
				...
				<li><a href="./assest/pages/Invite_page.jsp">
