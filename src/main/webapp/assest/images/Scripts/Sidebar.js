let User = localStorage.getItem('Current_user_Persona');
...
a_home_page.setAttribute("href", "./Home.html");
...
a_sell_page.setAttribute("href", "./Patient.html");
...
a_Cart.setAttribute("href", "./chatroom.html");
...
a_Profile.setAttribute("href", "./Appointment.html");
...
a_Profil.setAttribute("href", "./profile.html");
